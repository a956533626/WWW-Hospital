					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
							...
							<li class="nav-item dropdown active">
								...
								<div class="dropdown-menu">
									<a class="dropdown-item" href="admin-edit-appointment.jsp">编辑时间</a>
								</div>
							</li>	
						</ul>
					</div>
			...
			<!-- /Menu -->
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">Edit Time</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">设定坐诊时间</li>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">Edit Appointment Time</h3>
							<form>
								<div class="form-row">
									<div class="form-group col-md-6">
										<label for="doctor-id">Doctor ID</label>
										<input type="text" class="form-control" placeholder="Doctor ID" id="doctor-id">
									</div>
