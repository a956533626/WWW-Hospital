					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">用户账号管理</li>
							...
							<form>
								<div class="form-row">
									<div class="form-group col-md-6">
										<label for="patient-name">用户ID</label>
										<input type="text" class="form-control" placeholder="User ID" id="user-id">
									</div>
									
									<div class="form-group col-md-6">
										<label for="age">原密码</label>
										<input type="text" placeholder="Old Password" class="form-control" id="old-password">
									</div>
									<div class="form-group col-md-6">
										<label for="phone">新密码</label>
										<input type="text" placeholder="New Password" class="form-control" id="new-password">
									</div>
									<div class="form-group col-md-6">
										<label for="phone">确认新密码</label>
										<input type="text" placeholder="Confirm New Password" class="form-control" id="cfm-password">
									</div>
