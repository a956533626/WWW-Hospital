							...
							<form>
								<div class="form-row">
									<div class="form-group col-md-6">
										...
										<input type="text" class="form-control" placeholder="Doctor's Name" id="doctor-name">
									</div>
									<div class="form-group col-md-6">
										<label for="dob">Password</label>
										<input type="text" placeholder="Password" class="form-control" id="doctor-password">
                                    </div>
									<div class="form-group col-md-6">
									...
									<div class="form-group col-md-6">
										...
										<input type="text" placeholder="Major" class="form-control" id="major">
									</div>
									<div class="form-group col-md-3">
										<label for="start-time">Start Work Day</label>
									...
									<div class="form-group col-md-3">
										<label for="end-time">End Work day</label>
										<select class="form-control" id="end-time">
											...
											<option>周五</option>
											<option>周六</option>
											<option selected>周日</option>
										</select>
									</div>
									<div class="form-group col-md-6">
										<label for="about-doctor">Doctor's Introduction</label>
										<textarea placeholder="Doctor's Introduction" class="form-control" id="about-doctor" rows="3"></textarea>
                                    </div>
